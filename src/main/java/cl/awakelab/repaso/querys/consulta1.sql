...
INSERT INTO Pacientes (ID, Nombre, Fecha_Nacimiento)
VALUES (1, 'Juan Pérez', '1985-03-15'),
...
INSERT INTO Doctores (ID, Nombre, Experiencia, Especialidad_ID)
VALUES (1, 'Dr. Ramírez', 5, 1),
       (2, 'Dra. Rodríguez', 5, 2),
       (3, 'Dr. Fernández', 10, 3),
       (4, 'Dra. González', 15, 4),
       (5, 'Dr. Sánchez', 20, 5);
...
INSERT INTO Facturas (ID, Monto, Fecha_Pago)
VALUES (1, 100.00, '2023-07-26'),
       (2, 150.00, NULL),
       (3, 200.00, '2023-07-27'),
       (4, 250.00, '2023-07-28'),
       (5, 300.00, NULL),
...
INSERT INTO Citas (ID, Paciente_ID, Doctor_ID, Fecha, Factura_ID)
VALUES (1, 1, 1, '2023-07-25', 1),
       (2, 2, 2, '2023-07-26', 2),
       (3, 3, 3, '2023-07-27', 3),
       (4, 4, 4, '2023-07-28', 4),
       (5, 5, 5, '2023-07-29', 5),
...
INSERT INTO Historia_Clinica (ID, Paciente_ID, Doctor_ID, Fecha_Cita, Sintomas, Diagnostico, Tratamiento)
VALUES (1, 1, 1, '2023-07-25', 'Dolor en el pecho', 'Angina de pecho', 'Medicación y reposo'),
