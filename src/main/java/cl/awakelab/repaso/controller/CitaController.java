...
public class CitaController {
    ...
    public String listarCitas(Model model) {
        ...
        return "Users/listUsers"; // Cambiar la vista que corresponda para mostrar el listado de citas
    }
    ...
    public String mostrarFormularioCrearCita(Model model) {
        ...
        return "Users/createUser"; // Cambiar la vista que corresponda para mostrar el formulario de crear cita
    }
    ...
    public String crearCita(@ModelAttribute Cita citaCrear) {
        ...
        return "redirect:/cita"; // Cambiar la URL que corresponda para redirigir al listado de citas
    }
    ...
    public String mostrarFormularioEditarCita(@PathVariable int idCita, Model model) {
        ...
        return "Users/editUser"; // Cambiar la vista que corresponda para mostrar el formulario de editar cita
    }
